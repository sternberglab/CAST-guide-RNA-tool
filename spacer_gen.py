...
if __name__ == "main":
	spacer_gen({"outputPath": outputPath, "genbankId": genbankId, "email": email, "startPct": startPct, "endPct": endPct, "spacersPerRegion": spacersPerRegion, "target_gene_names": target_gene_names})
